...
cd libuuid-1.0.3
# sh configure --prefix /usr
CC=mipsel-uclibc-gcc CXX=mipsel-uclibc-g++ AR=mipsel-uclibc-ar RANLIB=/opt/brcm-arm/bin/mipsel-uclibc-ranlib ./configure --host=mipsel-uclibc-linux --prefix=/usr
